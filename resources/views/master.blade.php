...
<body>
    ...
    <!--FOOTER-->
    <footer>
        <video src="{{ 'img/footerVid.mp4' }}" class="footer" type="video/mp4" class="d-block w-100" autoplay loop
            muted>
        </video>
        <b>AINEWS {{ date('Y') }}
            <svg stroke-width="0" viewBox="0 0 1024 1024" height="1em" width="1em"
