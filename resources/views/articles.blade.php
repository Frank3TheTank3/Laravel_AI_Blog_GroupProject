...
<div class="content">
   <div class="section" style="padding:2rem; font-weight:bolder; font-size:2rem;">
      LATEST NEWS
   </div>
   ...
   <div class="container">
      ...
      <div class="row" id="article">
         <div class="col-sm" id="title" style="color: #5e17eb; padding:2rem; font-weight:bolder; font-size:larger;">
            {{$article->post_title}}
         </div>
